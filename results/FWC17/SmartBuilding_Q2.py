#data for Q2
ann = ['Δ2','Δ3','Δ4','Δ7','Δ10','Δ16']
x = [98.6,100.0,100.0,100.0,100.0,98.6]
y = [48.4,48.4,59.2,59.2,59.2,5.4]
z = [798.7,829.7,844.7,801.7,809.7,727.7]
...
ax.set_xlim3d(99, 100.02)
ax.set_ylim3d(48, 60)
ax.set_zlim3d(798, 850)
plt.tight_layout()
