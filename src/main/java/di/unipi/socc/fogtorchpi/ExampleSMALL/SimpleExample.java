...
public class SimpleExample {
    ...
    private static int sizePopulation = 20;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File logFile2 = new File("results/IEServices19/"+nameExperiment+"_fitness.txt");
            ...
            GAMonteCarloSearch search = new GAMonteCarloSearch(TIMES,new SimpleApp().createApp(),
                    new SimpleInfrastructure().createInfrastructure(),asList(),histogram,tracePopulation,numberGeneration,sizePopulation,mutationProb,writerFit);
            ...
            for (Deployment dep : histogram.keySet()) {
                ...
                System.out.println("GA;"+j + ";" + dep + ";" + histogram.get(dep).getA() + ";"
            ...
            writertimes.write(" GA :  Simulation ends: "+(timeEnd-timeStart)+"\n");
...
//        try {
//            String path = di.unipi.socc.fogtorchpi.ExampleBIG.SimpleExample.class.getProtectionDomain().getCodeSource().getLocation().getPath();
